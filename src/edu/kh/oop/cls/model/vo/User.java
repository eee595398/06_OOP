...
public class User {
	...
	public User(String userId, String userPw, String userName, int userAge, char userGender)
	{
		...
		// 생성자 내에서 반드시 첫번째 줄에 작성되어야한다 위에 다른 코드 쓰면 에러
		// 왜 사용하는가? 중복코드 제거, 코드 길이 감소, 재사용 증가
	...
	// 2) 매개변수의 개수, 타입, 순서 중 1개라도 달라야함
		...
		public User(String userId) {} // 매개변수의 개수 같은 생성자가 없음
										// 오버로딩 성립
		...
		public User(int user, String userId) {} 

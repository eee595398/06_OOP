...
public class MemberService {
	...
	public String signUp() {
		...
		if(memberPw.equals(memberPw2)) { // 일치하는 경우
			 ...
			 * return을 이욯해 전달할 값을 작성
			 * 
			 * return : 현재 메소드를 종료하고 호출한 곳으로 돌아감
			 * return 값; : 호출한 곳으로 돌아갈때 값을 가지고 감
			 */
	...
	// 로그인 메서드
			public String login() {
				...
				if(memberInfo == null) { // 회원가입을 먼저 안한경우 
				...
				// 저장된 아이디, 비밀번호가 입력된 아이디, 비밀번호와 같은면 "로그인 성공"
				...
				if(memberId.equals(memberInfo.getMemberId())&&
					...
					// 참조형 = Member 객체 주소(얇은 복사)
					
					// 회원가입정보를 loginMember에 대입하여 
					// 어떤회원이 로그인 했는지 구분 할 수 있게 함 
